classdef Kfclass2 < handle
    ...
    methods 
        ...
        function XYPositionKalmanFilter(obj, dt, Z)
            ...
            X_n1_n = F * X_n_n;                 % 6 * 1 卡尔曼滤波预测值

            P_n1_n = F * P_n_n * F' + Q;        % 6 * 6 预测值的协方差矩阵 
            ...
            for i = 1 : 2
                ...
                Z_n_diff_i = abs(Z_n(i) - obj.H(i, :) * X_n1_n);
                % 第i维度的量测误差
                ...
                K_i_1 = P_i_0 * obj.H(i, :)' / (obj.H(i, :) * P_n1_n * obj.H(i, :)' + obj.R(i, i));

                obj.K(:, i) = K_i_1;

                X_i_1 = X_i_0 + K_i_1 * (Z_n(i) - obj.H(i, :) * X_i_0);
                P_i_1 = P_i_0 - K_i_1 * obj.H(i, :) * P_i_0;
                X_i_0 = X_i_1;
                P_i_0 = P_i_1;
            end
